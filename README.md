...
* [docs/architecture/oscar-mgr-project-convention.md](docs/architecture/oscar-mgr-project-convention.md) — the layout/venv/account convention for future sibling "___Mgr" projects (PlexMgr, BackupMgr, etc.)
